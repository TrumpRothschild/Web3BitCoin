class HistoryOrderModel {
  ...
  HistoryOrderModel({this.msg, this.code, this.data});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['records'] != null) {
      ...
      json['records'].forEach((v) {
        records!.add(new HistoryRecords.fromJson(v));
      });
    }
    total = json['total'];
    size = json['size'];
...
class HistoryRecords {
  ...
  HistoryRecords.fromJson(Map<String, dynamic> json) {
