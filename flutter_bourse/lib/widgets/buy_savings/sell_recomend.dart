...
class SellRecommendViewsController extends GetxController {
  ...
  approveApi(BuildContext context,OrdersRows recommendRows,int? buySellType) async {
  ...
  transferCoin(BuildContext context,OrdersRows recommendRows,int? buySellType) async {
  ...
  void buyRecommendAccount(BuildContext context,String txHash,OrdersRows recommendRows,int? buySellType,String? state) async {
    LoadingProgress.ShowLoading(context);
  ...
  void depositAction(BuildContext context,OrdersRows recommendRows,int? buySellType) async {
...
class SellRecommendViews extends StatefulWidget {

  final OrdersRows? list;
  final int? buySellType;
  const SellRecommendViews({Key? key,required this.list,this.buySellType}) : super(key: key);

  @override
  State<SellRecommendViews> createState() => _SellRecommendViewssState();
}

class _SellRecommendViewssState extends State<SellRecommendViews> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SellRecommendViewsController>(
        init: SellRecommendViewsController(),
        builder: (h) => Scaffold(
