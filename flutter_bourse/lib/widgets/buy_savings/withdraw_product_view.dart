...
class WithdrawProductView extends StatefulWidget {
  final String? walletType;
  final int? orderId;
  const WithdrawProductView({Key? key,this.walletType,required this.orderId}) : super(key: key);

  @override
  State<WithdrawProductView> createState() => _WithdrawProductViewState();
}

class _WithdrawProductViewState extends State<WithdrawProductView> {
