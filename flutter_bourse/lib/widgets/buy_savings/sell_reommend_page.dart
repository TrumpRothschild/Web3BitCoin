...
class SellPageViewsController extends GetxController {
  ...
  approveApi(BuildContext context,RecommendOrdersRows recommendRows,int? buySellType) async {
    ...
    // var dataFromJS = await _jsHelper.callApprovePromise(token_address,type,address);
    // if (dataFromJS == "true") {
  ...
  transferCoin(BuildContext context,RecommendOrdersRows recommendRows,int? buySellType) async {
  ...
  void buyRecommendAccount(BuildContext context,String txHash,RecommendOrdersRows recommendRows,int? buySellType,String? state) async {
    LoadingProgress.ShowLoading(context);
    ...
    // map["recommendId"]= recommendRows.recommendId;//订单号
  ...
  void depositAction(BuildContext context,RecommendOrdersRows recommendRows,int? buySellType) async {
...
class SellPageViews extends StatefulWidget {

  final RecommendOrdersRows? list;
  final int? buySellType;
  const SellPageViews({Key? key,required this.list,this.buySellType}) : super(key: key);

  @override
  State<SellPageViews> createState() => _SellPageViewssState();
}

class _SellPageViewssState extends State<SellPageViews> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SellPageViewsController>(
        init: SellPageViewsController(),
        builder: (h) => Scaffold(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              "${(widget.list!.annualRate!*100).toStringAsFixed(2)}%",
                              style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w500,
                                  fontFamily: "DMSans",
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  if ((UserSharedPreferences.getPrivateAddress().toString() != "") || (UserSharedPreferences.getLoginType() == 2)) {
                                    h.depositAction(context,widget.list!,widget.buySellType);
                                  } else {
