...
class NFTPageView extends StatefulWidget {
  const NFTPageView({Key? key, this.callBack}) : super(key: key);

  final Function()? callBack;
  @override
  _NFTPageViewState createState() => _NFTPageViewState();
}
...
class _NFTPageViewState extends State<NFTPageView>
  ...
  var defiIconList = ["assets/images/APE.png","assets/images/GMT.png","assets/images/IMX.png","assets/images/CHR.png","assets/images/OGN.png","assets/images/CHZ.png","assets/images/Gala.png","assets/images/SUPER.png",];
  ...
  void selectMining() async {
    Uri url = Uri.parse('${APIs.apiPrefix}/web/pminer/list?minerType=2');
    final resMining = await http.get(url,
        headers: {"Content-Type": "application/json",
          'Accept': 'application/json',
          // 'Authorization': 'Bearer ${apiTokeResult.data!.token}'
                                              ...
                                              children: <Widget>[
                                                Container(
                                                  child: Row(
                                                    ...
                                                    children: <Widget>[
                                                      Countup(begin: 184.45, end: defiData!.profitRate!*100*365, prefix: '+', duration: const Duration(milliseconds: 1500), separator: ',', style: const TextStyle(overflow: TextOverflow.ellipsis,fontFamily: "DMSans", fontWeight: FontWeight.w900, fontSize: 18,color: ColorConstants.AppGreenColor),),
                                                      Text(
                                                        "%",
                                                        textAlign: TextAlign.right,
                                                        style: TextStyle(
