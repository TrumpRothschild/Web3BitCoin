...
class TransactionOrderCell extends GetView<TransactionHistory> {

  final SavingsRows list;
  const TransactionOrderCell({
    Key? key,
    required this.list,
  }) : super(key: key);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            (list.direction == "0") ? translate('home.deposit') : translate('home.Extract'),
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.w900,
                                fontSize: 15),
